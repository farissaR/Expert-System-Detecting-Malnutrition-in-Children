				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/g1_2.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-2"><?php echo $lang['g1-a'] ?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadG1"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadG1'])){
									$g1a = $_POST['optradio'];
									$query = "UPDATE data_anak SET g1a ='$g1a' WHERE id='$id'";
									$result = mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("g1_b.php?id='.$id.'");</script>';
									}else{
