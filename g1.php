				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/g1.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-2"><?php echo $lang['g1'] ?></span></h2><br>
								...
								if(isset($_POST['uploadG1'])){
									$g1 = $_POST['optradio'];
									$query="UPDATE data_anak SET g1='$g1' WHERE id='$id'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("g1_a.php?id='.$id.'");</script>';
									}else{
