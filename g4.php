				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/g4.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['g4']; ?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadG4"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadG4'])){
									$g4 = $_POST['optradio'];
									$query="UPDATE `data_anak` SET `g4`='".$g4."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("g5.php?id='.$id.'");</script>';
									}else{
