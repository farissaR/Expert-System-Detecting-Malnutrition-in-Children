				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="<?php echo $lang['img-g2'];?> alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['g2']; ?> </span><br>
									<h6><?php echo $lang['g2-cont']; ?></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadG2"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadG2'])){
									$g2 = $_POST['optradio'];
									$query="UPDATE `data_anak` SET `g2`='".$g2."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("g3.php?id='.$id.'");</script>';
									}else{
