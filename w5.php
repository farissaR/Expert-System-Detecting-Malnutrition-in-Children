					...
					<div class="row fullscreen align-items-center justify-content-center">
						...
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['w5'];?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadW5"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadW5'])){

									$w5 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `w5`='".$w5."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("w6.php?id='.$id.'");</script>';
									}else{
