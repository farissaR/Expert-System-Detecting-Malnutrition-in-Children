					...
					<div class="row fullscreen align-items-center justify-content-center">
						...
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['q7']; ?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadQ7"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadQ7'])){

									$q7 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `q7`='".$q7."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
									    include 'calculate.php';
										$hasil_stunt = stunting();
