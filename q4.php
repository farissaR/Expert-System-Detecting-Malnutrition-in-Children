				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="<?php echo $lang['img-q4']; ?>" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['q4']; ?></span>
								<h6><span class="sp-1"><?php echo $lang['q4-cont']; ?></span></h6><br>
								...
								<input type = "submit" class="genric-btn primary circle arrow" name="uploadQ4"></input>
							</form>
							<?php
							require('db.php');
							if(isset($_POST['uploadQ4'])){

								$q4 = $_POST['optradio'];

								$query="UPDATE `data_anak` SET `q4`='".$q4."' WHERE `id`='".$id."'";
								$result= mysqli_query($con, $query);
								if($result){
									echo '<script> location.replace("q5.php?id='.$id.'");</script>';
								}else{
