				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/w2_a.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-2"><?php echo $lang['w2-a'] ?></span></h2>
								...
								if(isset($_POST['uploadW2'])){
									...
									$query="UPDATE `data_anak` SET `w2a`='".$w2a."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("w3.php?id='.$id.'");</script>';
									}else{
