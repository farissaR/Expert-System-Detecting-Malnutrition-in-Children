				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/g6.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"></span>
									<span class="sp-2"><?php echo $lang['g6']; ?></span></h2><br>
									<h6><?php echo $lang['g6-cont']; ?></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadG6"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadG6'])){
									$g6 = $_POST['optradio'];
									$query="UPDATE `data_anak` SET `g6`='".$g6."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
									    include 'calculate.php';
										$hasil_obese = obesitas();
										echo '<script> location.replace("hasil.php?id='.$id.'");</script>';
									}else{
									    //ga masuk db
