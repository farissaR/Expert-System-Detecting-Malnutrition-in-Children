				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="img/g3.png" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['g3']; ?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadG3"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadG3'])){
									$g3 = $_POST['optradio'];
									$query="UPDATE `data_anak` SET `g3`='".$g3."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("g4.php?id='.$id.'");</script>';
									}else{
