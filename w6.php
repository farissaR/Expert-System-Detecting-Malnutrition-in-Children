				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="<?php echo $lang['img-w6']; ?>" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-2"><?php echo $lang['w6'] ?></span></h2>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadW2"></input>
								</form>
								<?php
								require('db.php');
								...
								while ($row = mysqli_fetch_array($query1)) {
									$Z_score_pb_u = $row['z_score_pbu'];}
								// echo "index pbu :".$Z_score_pb_u;

								if(isset($_POST['uploadW2'])){

									$w6 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `w6`='".$w6."' WHERE `id`='".$id."'";
