					...
					<div class="row fullscreen align-items-center justify-content-center">
						...
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['q2']; ?></h6><br>
									<h6><span class="sp-1"><?php echo $lang['q2-cont']; ?></span></h2><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadQ2"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadQ2'])){

									$q2 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `q2`='".$q2."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("q3.php?id='.$id.'");</script>';
									}else{
