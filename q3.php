				...
				<div class="container">
					<div class="row fullscreen align-items-center justify-content-center">
						<div class="banner-left col-lg-6">
							<img class="d-flex mx-auto img-fluid" src="<?php echo $lang['img-q3'] ?>" alt="">
						</div>
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['q3']; ?></span>
								<h6><span class="sp-1"><?php echo $lang['q3-cont']; ?></span></h6><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadQ3"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadQ3'])){

									$q3 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `q3`='".$q3."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("q4.php?id='.$id.'");</script>';
									}else{
