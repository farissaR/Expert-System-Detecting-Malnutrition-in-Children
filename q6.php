					...
					<div class="row fullscreen align-items-center justify-content-center">
						...
						<div class="col-lg-6">
							<div class="story-content">
								<h2><span class="sp-1"><?php echo $lang['q6']; ?></span>
									<h6><span class="sp-1"><?php echo $lang['q6-cont']; ?></span></h6><br>
									...
									<input type = "submit" class="genric-btn primary circle arrow" name="uploadQ6"></input>
								</form>
								<?php
								require('db.php');
								if(isset($_POST['uploadQ6'])){

									$q6 = $_POST['optradio'];

									$query="UPDATE `data_anak` SET `q6`='".$q6."' WHERE `id`='".$id."'";
									$result= mysqli_query($con, $query);
									if($result){
										echo '<script> location.replace("q7.php?id='.$id.'");</script>';
									}else{
